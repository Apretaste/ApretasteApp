...
import apretaste.ServiceDetails;
import apretaste.db.DataBaseManager;
import apretaste.email.Mailer;
import apretaste.email.Mailerlistener;
import apretaste.settings.SettingsActivity;
...
public class MainActivity extends AppCompatActivity implements HistoryManager.HistoryListener, Mailerlistener {
    ...
    TextView notifCount;
    DataHelper datautil = new DataHelper();
    GridView gridview;
    ...
    public void onHistoryChange(HistoryEntry newUrl) {
        if(newUrl!=null)
        {
            ...
            appbar.setTitle(newUrl.service);
            showHomeButton(true);
    ...
    public void onError(final Exception e) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if (!networkHelper.haveConn(MainActivity.this)){
                    dialogHelper.simpleAlert(MainActivity.this,"Error","Usted debe enceder los datos moviles o conectarse a una red wifi para poder usar nuestra app");
    ...
    public void onResponseArrived(String service, String command, String response, Mailer mailer) {
        ...
        if (mailer.mincache != ""){
            ...
            new StringHelper().clearString(command);

            manager.insertar(new StringHelper().clearString(command),datautil.addMinutes(mailer.mincache),file.toURI().toString());
                        ...
                        final AlertDialog alertDialog = new AlertDialog.Builder(MainActivity.this)
                                ...
                                .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        String peticion = new StringHelper().clearString((command+" "+extra));
                                        ...
                                        if (!manager.getAll(peticion,"peticion").equals("")){
                                            ...
                                            try {
                                                if (dataHelper.compareTwoDates(dataHelper.getNowDateTime(),manager.getAll(peticion,"cache"))){
                    ...
                    public void onClick(DialogInterface dlg, int which) {
                        switch (which)
                        {
                            case 0:{
                                ...
                                DataBaseManager manager = new DataBaseManager(MainActivity.this);
                               String peticion = new StringHelper().clearString((pro.services[position].name));
                               ...
                               final AlertDialog alertDialog = new AlertDialog.Builder(MainActivity.this).setView(v).setMessage("Escriba un texto para ejecutar dentro del servicio")
                                        .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                String peticion = new StringHelper().clearString(((pro.services[position].name+" "+extra)) );
                                               if (!manager.getAll(peticion,"peticion").equals("")){
                            ...
                            case 2:{
                                ...
                                Toast.makeText(getBaseContext(),"detalles",Toast.LENGTH_LONG).show();
