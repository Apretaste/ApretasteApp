...
public class ParameterList {
	...
	try {
        for (Object multisegmentName : multisegmentNames) {
            String name = (String) multisegmentName;
		 ...
		 */
            ...
            for (segment = 0; ; segment++) {
                ...
                if (v instanceof Value) {
                    ...
                    } catch (NumberFormatException | StringIndexOutOfBoundsException | UnsupportedEncodingException nex) {
