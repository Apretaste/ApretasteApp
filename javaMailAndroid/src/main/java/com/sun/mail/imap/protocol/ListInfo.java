...
public class ListInfo { 
	...
	if (s != null) {
        ...
        for (String value : s) {
            if (value.equalsIgnoreCase("\\Marked"))
                changeState = CHANGED;
            else if (value.equalsIgnoreCase("\\Unmarked"))
                changeState = UNCHANGED;
            else if (value.equalsIgnoreCase("\\Noselect"))
                canOpen = false;
            else if (value.equalsIgnoreCase("\\Noinferiors"))
                hasInferiors = false;
            v.addElement(value);
        }
	}
