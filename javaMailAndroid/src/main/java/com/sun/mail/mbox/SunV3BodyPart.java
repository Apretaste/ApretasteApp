...
public class SunV3BodyPart extends MimeBodyPart {
	...
	static String toMime(String s) {
        for (MimeV3Map aMimeV3Table : MimeV3Table) {
            if (aMimeV3Table.v3.equalsIgnoreCase(s))
                return aMimeV3Table.mime;
        }
	...
	static String toV3(String s) {
        for (MimeV3Map aMimeV3Table : MimeV3Table) {
            if (aMimeV3Table.mime.equalsIgnoreCase(s))
                return aMimeV3Table.v3;
        }
	    return s;
	}
    }
